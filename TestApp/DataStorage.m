...
static DataStorage *_sharedDataStorage = nil;
...
+ (DataStorage *)sharedDataStorage
{
    if (!_sharedDataStorage) {
        _sharedDataStorage = [[DataStorage alloc] init];
    }
...
{
    if (![self hasDataBaseShotID:shot.shotId]) {
        ...
        newFavorite.favTitle = shot.shotTitle;
        newFavorite.favUrl = shot.shotImageUrl;
        newFavorite.favId = [NSString stringWithFormat:@"%i", [shot.shotId intValue]];
...
- (BOOL) hasDataBaseShotID: (NSString *) shotId
{
    ...
    for (Favorite *fav in allFavorites) {
        if ([fav.favId isEqualToString:shotId]) {
            return YES;
        }
    }
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"dribbble_model" withExtension:@"momd"];
